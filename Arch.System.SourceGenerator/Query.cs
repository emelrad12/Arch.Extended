            ...
            {{(!queryMethod.IsGlobalNamespace ? $"namespace {queryMethod.Namespace} {{" : "")}}
                partial class {{queryMethod.ClassName}}{
                    ...
                    public {{staticModifier}} JobHandle {{queryMethod.MethodName}}QueryAsync(World world {{data}}){
                        ...
                        var job = new {{queryMethod.MethodName}}QueryJobChunk() { {{jobParametersAssigment}} };
                        return world.AdvancedInlineParallelChunkQuery(in {{queryMethod.MethodName}}_QueryDescription, job);
                    }
                    ...
                    public {{staticModifier}} JobHandle {{queryMethod.MethodName}}Query(World world {{data}}){
                        ...
                        var job = new {{queryMethod.MethodName}}QueryJobChunk() { {{jobParametersAssigment}} };
                        var handle = world.AdvancedInlineParallelChunkQuery(in {{queryMethod.MethodName}}_QueryDescription, job);
                        handle.Wait();
                        return handle;
                    }
                }
